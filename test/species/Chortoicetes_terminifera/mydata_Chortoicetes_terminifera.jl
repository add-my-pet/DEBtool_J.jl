...
# tW-data 
# tW_26 = [ # time since birth (d), dry weight (g)
#     0       data.Wdb
#     8.85	data.Wd2
#     16.45	data.Wd3
#     27.2	data.Wd4
...
# tW_27 = [ # time since birth (d), dry weight (g)
#     0       data.Wdb
#     6.25	data.Wd2
#     14.4	data.Wd3
#     21.75	data.Wd4
...
# tW_29 = [ # time since birth (d), dry weight (g)
#     0       data.Wdb
#     5.7     data.Wd2
#     11.7	data.Wd3
#     17.6	data.Wd4
...
EstimationData(;
    ...
    dryweight = (
        ...
        Moult{3}(5.56e-3u"g"),
        Moult{4}(11.71e-3u"g"),
        Moult{5}(25.53e-3*1.5u"g"),
        Puberty(0.1095u"g"),
    ),
    reproduction = 72*3/60u"d^-1",
    pseudo = (; v=Weighted(0.5, 0.02u"cm/d")),
)
